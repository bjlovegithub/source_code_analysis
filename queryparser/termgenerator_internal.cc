...
{
    DEBUGCALL(DB, void, "TermGenerator::Internal::index_text", "");
	...
	// Advance to the start of the next term.
      ...
      endofterm:
        ...
        stem += prefix;
        stem += stemmer(term);
        LOGLINE(DB, "Add stem: " << stem << " to doc");
